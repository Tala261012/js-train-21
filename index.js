...
// const petr = new Guitarist("Петр", "роялi", "Opera"); //my
// petr.play(); //my
...
Object.defineProperty(Musician.prototype, "band", {
  set(newBand) {
    this.band = newBand; //TODO   this._band
  },
});
...
class Band {
  ...
  addMember(newMember) {
    ...
    // Ось тут ми використовуємо сетер band класу Musician //TODO ??????????????????????????????????????????
...
// const vokalist = new Vocalist("Fedor", "ZZ top");
// console.log(vokalist.info());
...
// const list = new SongWriter(["a", "b", "c"]);
